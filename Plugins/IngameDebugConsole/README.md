...
This repository is a maintained fork of [yasirkula/UnityIngameDebugConsole](https://github.com/yasirkula/UnityIngameDebugConsole), prepared for publishing to the private Unity Package Manager registry at `https://upm.thanhdv.com`.

**Fork repository:** https://github.com/ThanhDV143/Fork.Lib.UnityIngameDebugConsole

**Original Asset Store page:** https://assetstore.unity.com/packages/tools/gui/in-game-debug-console-68068

**Original forum thread:** http://forum.unity3d.com/threads/in-game-debug-console-with-ugui-free.411323/
...
```
https://github.com/ThanhDV143/Fork.Lib.UnityIngameDebugConsole.git
```
...
- Press the **+** button, choose "**Add package by name...**" → ``thanhdv.fork.yasirkula.ingamedebugconsole``
- or
